--[[
    NO MERCY x BURNER HUB — VIOLENCE DISTRICT  v3.2 (FLUENT UI)
...
local Window = Fluent:CreateWindow({
    Title = "NO MERCY",
    SubTitle = "Violence District | v3.4",
    TabWidth = 160,
...
-- Bubble toggle button (logo ninja) — buka/tutup menu
local BubbleGui = Instance.new("ScreenGui")
BubbleGui.Name = "NoMercyBubbleGui"
BubbleGui.ResetOnSpawn = false
BubbleGui.Parent = (gethui and gethui()) or game:GetService("CoreGui")
...
do
    ...
    s.Color = Color3.fromRGB(50, 60, 70)
    s.Thickness = 2
    s.Parent = BubbleBtn
end
...
-- ===== BAGIAN 14B : FITUR TAMBAHAN (AIMBOT / PARRY / MOONWALK / EMOTE / PLAYER) =====
...
-- ---------- EMOTE ----------
local EmoteConfig = { Enabled = true }
local EmoteData = {
    { Name = "Backflip", AnimationId = "rbxassetid://74705617908505", SoundId = nil },
    { Name = "Amukan", AnimationId = "rbxassetid://79155929355612", SoundId = nil },
    { Name = "Gelombang", AnimationId = "rbxassetid://99670106766588", SoundId = nil },
    { Name = "Istirahat Terapung", AnimationId = "rbxassetid://114593021219597", SoundId = nil },
    { Name = "Ayunan Lengan", AnimationId = "rbxassetid://123701924525875", SoundId = "rbxassetid://74216458932348" },
    { Name = "Mannrobiks", AnimationId = "rbxassetid://134677515695156", SoundId = "rbxassetid://109596159930017" },
    { Name = "Boneka Rusak", AnimationId = "rbxassetid://131796630104825", SoundId = "rbxassetid://88284355540646" },
    { Name = "Jumat Malam", AnimationId = "rbxassetid://83229063951016", SoundId = "rbxassetid://85355610204255" },
    { Name = "OnePlays", AnimationId = "rbxassetid://140625405103474", SoundId = "rbxassetid://94749073728335" },
    { Name = "WarCry", AnimationId = "rbxassetid://82600868380136", SoundId = nil },
    { Name = "Balikan Cepat", AnimationId = "rbxassetid://130933486827090", SoundId = "rbxassetid://137966860089117" },
    { Name = "Rentan", AnimationId = "rbxassetid://73896868179198", SoundId = "rbxassetid://124209794918032" },
    { Name = "Emote Tambahan", AnimationId = "rbxassetid://121773684313913", SoundId = "rbxassetid://135265751184744" },
    { Name = "Kyoufuu", AnimationId = "rbxassetid://137322894494527", SoundId = "rbxassetid://129064643026442" },
    { Name = "Kombo Cepat", AnimationId = "rbxassetid://105592621576604", SoundId = "rbxassetid://88505795419631" },
}
...
local function stopEmote()
    ...
    pcall(function()
        local r = RemoteCache.Get("EmoteHandler")
        if r then r:FireServer("StopEmote") end
    end)
end

local function playEmote(index)
    if not EmoteConfig.Enabled then return end
    ...
    if ed.SoundId then
        ...
        if hrp then
            ...
            currentSound.SoundId = ed.SoundId
...
LocalPlayer.CharacterAdded:Connect(function(char)
    ...
    if hum then hum.Died:Connect(function() stopEmote(); currentEmoteIx = nil end) end
...
Tabs.ESP:AddButton({ Title = "Refresh ESP", Callback = function()
    ClearESP()
    if Settings.ESP.Master then espDirty = true; ScanWorld(); lastUpdate = 0; ESPTick() end
    Notify("ESP", (Settings.ESP.Master and "ESP di-refresh") or "Master ESP masih OFF", 2)
end })

-- ---------- TAB : GAMEPLAY ----------
Breathe()
Tabs.Gameplay:AddSection("AUTO FEATURES")
...
-- ---------- TAB : EMOTE ----------
Tabs.Emote:AddToggle("EmoteEnabled", { Title = "Aktifkan Sistem Emote", Default = true }):OnChanged(function(value)
    EmoteConfig.Enabled = value
    if not value then stopEmote(); currentEmoteIx = nil end
end)
for emoteIndex, emoteInfo in ipairs(EmoteData) do
    Tabs.Emote:AddButton({
        Title = emoteInfo.Name,
        Description = "Klik lagi untuk berhenti",
        Callback = function() playEmote(emoteIndex) end,
    })
end
Tabs.Emote:AddButton({
    Title = "Stop Emote",
    Callback = function() stopEmote(); currentEmoteIx = nil; Notify("Emote", "Dihentikan", 2) end,
})
...
Tabs.Settings:AddButton({
    ...
    Callback = function()
        ...
        destroyRing(); stopFly(); disableGodMode(); stopEmote()
...
if getgenv then
    getgenv().NoMercyUnload = function()
        ...
        pcall(function() destroyRing(); stopFly(); disableGodMode(); stopEmote() end)
